...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo Text::_('COM_JOOMLA_V4_COMPONENTS_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body modal-batch">
		<p><?php echo Text::_('COM_JOOMLA_V4_COMPONENTS_BATCH_TIP'); ?></p>
		<div class="row">
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('joomla_v4_component.batch');">
