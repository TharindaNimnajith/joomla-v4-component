...
<form action="<?php echo Route::_('index.php?option=com_joomla_v4_components&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="joomla_v4_component-form" class="form-validate">
