CREATE TABLE IF NOT EXISTS `#__joomla_v4_components_details` (
...
INSERT INTO `#__joomla_v4_components_details` (`name`) VALUES
('Nina'),
('Astrid'),
('Elmar');
...
ALTER TABLE `#__joomla_v4_components_details` ADD COLUMN  `catid` int(11) NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__joomla_v4_components_details` ADD COLUMN  `state` tinyint(3) NOT NULL DEFAULT 0 AFTER `alias`;

ALTER TABLE `#__joomla_v4_components_details` ADD KEY `idx_catid` (`catid`);
...
ALTER TABLE `#__joomla_v4_components_details` ADD COLUMN  `language` char(7) NOT NULL DEFAULT '*' AFTER `alias`;

ALTER TABLE `#__joomla_v4_components_details` ADD KEY `idx_language` (`language`);

ALTER TABLE `#__joomla_v4_components_details` ADD COLUMN  `ordering` int(11) NOT NULL DEFAULT 0 AFTER `alias`;
