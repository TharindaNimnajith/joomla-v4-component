...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo Text::_('COM_JOOMLA-V4-COMPONENTS_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body modal-batch">
		<p><?php echo Text::_('COM_JOOMLA-V4-COMPONENTS_BATCH_TIP'); ?></p>
		<div class="row">
		...
		<?php if ($published >= 0) : ?>
			<div class="form-group col-md-6">
				<div class="controls">
					<?php echo LayoutHelper::render('joomla.html.batch.item', ['extension' => 'com_joomla-v4-components']); ?>
				</div>
			</div>
		<?php endif; ?>
		<div class="form-group col-md-6">
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('joomla-v4-component.batch');">
